...
if (!class_exists('MCProtectFWRuleEngine_V545')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V545 {
	use MCProtectFWRuleStringFunc_V545;
	use MCProtectFWRuleArrayFunc_V545;
	use MCProtectFWRuleMiscFunc_V545;
	use MCProtectFWRuleRequestFunc_V545;
	use MCProtectFWRuleWPFunc_V545;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V545::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V545 $e) {
			$this->error = $e;
		}
	}
