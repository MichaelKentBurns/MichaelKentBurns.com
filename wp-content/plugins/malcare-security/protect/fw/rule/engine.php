...
if (!class_exists('MCProtectFWRuleEngine_V547')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V547 {
	use MCProtectFWRuleStringFunc_V547;
	use MCProtectFWRuleArrayFunc_V547;
	use MCProtectFWRuleMiscFunc_V547;
	use MCProtectFWRuleRequestFunc_V547;
	use MCProtectFWRuleWPFunc_V547;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V547::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V547 $e) {
			$this->error = $e;
		}
	}
