...
if (!class_exists('CWMGRWPAction')) :
	class CWMGRWPAction {
		...
		public function __construct($settings, $siteinfo, $bvapi) {
			...
			$this->bvapi = $bvapi;
			$this->bvinfo = new CWMGRInfo($settings);
		}
		...
		public static function uninstall() {
			...
			##CLEARDYNSYNCCONFIG##
			##CLEARCACHECONFIG##
			do_action('cwmgr_clear_bv_services_config');
			##CLEAR_WP_2FA_CONFIG##
