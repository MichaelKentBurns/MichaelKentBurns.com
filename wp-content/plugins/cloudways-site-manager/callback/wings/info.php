...
if (!class_exists('CWMGRInfoCallback')) :

class CWMGRInfoCallback extends CWMGRCallbackBase {
	public $db;
	public $settings;
	public $siteinfo;
	public $bvinfo;
	...
	public function __construct($callback_handler) {
		...
		$this->bvapi = new CWMGRWPAPI($this->settings);
	}
	...
	public function getSystemInfo() {
		$sys_info = array(
			'host' => CWMGRHelper::getRawParam('SERVER', 'HTTP_HOST'),
			'phpversion' => phpversion(),
			'AF_INET6' => defined('AF_INET6')
		);
		if (array_key_exists('SERVER_ADDR', $_SERVER)) {
			$sys_info['serverip'] = CWMGRHelper::getRawParam('SERVER', 'SERVER_ADDR');
		}
	...
	public function getWpInfo() {
		...
		$wp_info = array(
			...
			'abspath' => ABSPATH,
			'bvpluginpath' => defined('CWMGRBASEPATH') ? CWMGRBASEPATH : null,
	...
	public function getHostInfo() {
		...
		if (isset($_SERVER['SERVER_ADDR']) && function_exists('gethostbyaddr')) {
			$host_info['HOST_FROM_IP'] = gethostbyaddr(CWMGRHelper::getRawParam('SERVER', 'SERVER_ADDR'));
		}
	...
	public function serverConfig() {
		return array(
			'software' => CWMGRHelper::getRawParam('SERVER', 'SERVER_SOFTWARE'),
