...
if (!class_exists('CWMGRMiscCallback')) :
	
class CWMGRMiscCallback extends CWMGRCallbackBase {
	public $settings;
	public $bvinfo;
	public $siteinfo;
	public $account;
	...
	public function __construct($callback_handler) {
		...
		$this->bvinfo = new CWMGRInfo($callback_handler->settings);
		$this->bvapi = new CWMGRWPAPI($callback_handler->settings);
	}
